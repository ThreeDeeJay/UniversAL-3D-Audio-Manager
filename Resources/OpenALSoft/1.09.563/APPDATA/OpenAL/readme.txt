...
The included openal-info.exe program can be used to tell if the OpenAL Soft DLL is being detected. It should be run from a command shell, as the program will exit as soon as it's done printing information. OpenAL Soft's playback devices will appear as strings starting with "DirectSound Software".
